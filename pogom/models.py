...
from . import config
from .utils import get_pokemon_name, get_args, get_interesting_pokemons
...
def parse_map(map_dict, iteration_num, step, step_location):
    ...
    active_encounter_ids = [p['encounter_id'] for p in Pokemon.get_active(None,None,None,None)]
